...
compact_js_path = ROOT / "static" / "js" / "modules" / "additional_fields_compact_layout_v2.js"
...
# ###################################################################################
# (3) REMOVER SCRIPTS ANTIGOS E INCLUIR V2
# ###################################################################################

template_content = template_path.read_text(encoding="utf-8")

template_content = re.sub(
    r'\\s*<script src="/static/js/modules/additional_fields_compact_layout_v[12]\\.js\\?[^"]*"></script>',
    '',
    template_content
)
...
new_script = '<script src="/static/js/modules/additional_fields_compact_layout_v2.js?v=20260429-compact-layout-v2"></script>'
...
print("OK: layout compacto v2 aplicado.")
