...
JS_V4_PATH = ROOT / "static" / "js" / "modules" / "process_fields_header_manager_v4.js"
...
JS_V4_PATH.write_text(js_content, encoding="utf-8")


####################################################################################
# (5) ATUALIZAR TEMPLATE PARA USAR SOMENTE V4
####################################################################################
...
template = re.sub(
    r'\s*<script src="/static/js/modules/process_fields_header_manager_v3\.js\?v=[^"]+"></script>',
    "",
    template,
)

script_tag = '<script src="/static/js/modules/process_fields_header_manager_v4.js?v=20260430-fields-header-v4"></script>'

if "process_fields_header_manager_v4.js" not in template:
    ...
    template = re.sub(
        r'/static/js/modules/process_fields_header_manager_v4\.js\?v=[^"]+',
        '/static/js/modules/process_fields_header_manager_v4.js?v=20260430-fields-header-v4',
        template,
    )

TEMPLATE_PATH.write_text(template, encoding="utf-8")

print("OK: process_fields_header_manager_v4.js criado.")
print("OK: new_user.html atualizado.")
print("OK: patch_process_fields_header_manager_v4 concluído.")
