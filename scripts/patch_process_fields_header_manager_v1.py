...
JS_PATH = ROOT / "static" / "js" / "modules" / "process_fields_header_manager_v1.js"
...
replacements = {
    "CAMPO DO PROCESSO": "NOME DO CAMPO",
    "Campo do processo": "Nome do campo",
    "campo do processo": "nome do campo",
}
...
print("OK: texto Campo do processo alterado para Nome do campo no template.")


####################################################################################
# (4) CRIAR JS COMPLETO DO GERENCIADOR DE CABECALHO DO CAMPO
####################################################################################
...
print("OK: JS process_fields_header_manager_v1.js criado.")


####################################################################################
# (5) INCLUIR JS NO TEMPLATE
####################################################################################

script_tag = '<script src="/static/js/modules/process_fields_header_manager_v1.js?v=20260430-fields-header-v1"></script>'

if "process_fields_header_manager_v1.js" not in template:
    ...
    print("OK: process_fields_header_manager_v1.js incluído em new_user.html.")
else:
    template = re.sub(
        r'/static/js/modules/process_fields_header_manager_v1\.js\?v=[^"]+',
        '/static/js/modules/process_fields_header_manager_v1.js?v=20260430-fields-header-v1',
        template,
    )
    print("OK: cache buster do process_fields_header_manager_v1.js atualizado.")
...
print("OK: patch_process_fields_header_manager_v1 concluído.")
