...
group_js_path = ROOT / "static" / "js" / "modules" / "additional_fields_header_groups_v4.js"
...
# ###################################################################################
# (3) TROCAR SCRIPT V3 PELO V4 NO TEMPLATE
# ###################################################################################
...
template_content = re.sub(
    r'\\s*<script src="/static/js/modules/additional_fields_header_groups_v4\\.js\\?[^"]*"></script>',
    '',
    template_content
)
...
new_script = '<script src="/static/js/modules/additional_fields_header_groups_v4.js?v=20260429-header-groups-v4"></script>'
...
print("OK: agrupamento v4 aplicado.")
