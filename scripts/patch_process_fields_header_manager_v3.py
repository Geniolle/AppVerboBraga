...
JS_V3_PATH = ROOT / "static" / "js" / "modules" / "process_fields_header_manager_v3.js"
...
print("OK: texto Campo do processo alterado para Nome do campo.")
...
JS_V3_PATH.write_text(js_content, encoding="utf-8")

print("OK: JS process_fields_header_manager_v3.js criado.")


####################################################################################
# (5) ATUALIZAR TEMPLATE PARA USAR SOMENTE V3
####################################################################################

template = re.sub(
    r'\s*<script src="/static/js/modules/process_fields_header_manager_v1\.js\?v=[^"]+"></script>',
    "",
    template,
)

template = re.sub(
    r'\s*<script src="/static/js/modules/process_fields_header_manager_v2\.js\?v=[^"]+"></script>',
    "",
    template,
)

script_tag = '<script src="/static/js/modules/process_fields_header_manager_v3.js?v=20260430-fields-header-v3"></script>'

if "process_fields_header_manager_v3.js" not in template:
    ...
    print("OK: process_fields_header_manager_v3.js incluído em new_user.html.")
else:
    template = re.sub(
        r'/static/js/modules/process_fields_header_manager_v3\.js\?v=[^"]+',
        '/static/js/modules/process_fields_header_manager_v3.js?v=20260430-fields-header-v3',
        template,
    )
    print("OK: cache buster do process_fields_header_manager_v3.js atualizado.")

TEMPLATE_PATH.write_text(template, encoding="utf-8")

print("OK: new_user.html atualizado.")
print("OK: patch_process_fields_header_manager_v3 concluído.")
