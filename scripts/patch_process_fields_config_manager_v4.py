...
JS_PATH = ROOT / "static" / "js" / "modules" / "process_fields_config_manager_v4.js"
...
print("OK: process_fields_config_manager_v4.js criado.")
...
# Remove CSS auxiliar antigo que ficou a interferir no layout.
template = re.sub(
...
# Remove todos os header managers antigos.
...
# Remove versões antigas do gestor oficial.
template = re.sub(
    r'/static/js/modules/process_fields_config_manager_v1\.js\?v=[^"]+',
    '/static/js/modules/process_fields_config_manager_v4.js?v=20260430-fields-config-v4',
    template,
)
...
template = re.sub(
    r'/static/js/modules/process_fields_config_manager_v3\.js\?v=[^"]+',
    '/static/js/modules/process_fields_config_manager_v4.js?v=20260430-fields-config-v4',
    template,
)

if "process_fields_config_manager_v4.js" not in template:
    script_tag = '<script src="/static/js/modules/process_fields_config_manager_v4.js?v=20260430-fields-config-v4"></script>'
...
print("OK: new_user.html atualizado para carregar somente process_fields_config_manager_v4.js.")
print("OK: patch_process_fields_config_manager_v4 concluído.")
