...
JS_V2_PATH = ROOT / "static" / "js" / "modules" / "process_fields_header_manager_v2.js"
...
####################################################################################
# (3) RENOMEAR TEXTO CAMPO DO PROCESSO PARA NOME DO CAMPO
####################################################################################
...
JS_V2_PATH.write_text(js_content, encoding="utf-8")

print("OK: JS process_fields_header_manager_v2.js criado.")


####################################################################################
# (5) ATUALIZAR TEMPLATE PARA USAR V2
####################################################################################
...
script_tag = '<script src="/static/js/modules/process_fields_header_manager_v2.js?v=20260430-fields-header-v2"></script>'

if "process_fields_header_manager_v2.js" not in template:
    ...
    print("OK: process_fields_header_manager_v2.js incluído em new_user.html.")
else:
    template = re.sub(
        r'/static/js/modules/process_fields_header_manager_v2\.js\?v=[^"]+',
        '/static/js/modules/process_fields_header_manager_v2.js?v=20260430-fields-header-v2',
        template,
    )
    print("OK: cache buster do process_fields_header_manager_v2.js atualizado.")
...
print("OK: patch_process_fields_header_manager_v2 concluído.")
