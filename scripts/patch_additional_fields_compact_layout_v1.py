...
compact_js_path = ROOT / "static" / "js" / "modules" / "additional_fields_compact_layout_v1.js"
...
compact_js_path.write_text(compact_js_content, encoding="utf-8")

# ###################################################################################
# (3) REMOVER SCRIPTS ANTIGOS E INCLUIR LAYOUT COMPACTO
# ###################################################################################
...
template_content = re.sub(
    r'\\s*<script src="/static/js/modules/additional_fields_compact_layout_v1\\.js\\?[^"]*"></script>',
    '',
    template_content
)

new_script = '<script src="/static/js/modules/additional_fields_compact_layout_v1.js?v=20260429-compact-layout-v1"></script>'
...
print("OK: layout fechado/simplificado dos Campos adicionais aplicado.")
