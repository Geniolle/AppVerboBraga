...
- `scripts/`: comandos operacionais (`bootstrap_admin`, `init_db`, `validate_web_app`) e scripts pontuais de diagnostico/reparacao — ver `docs/operations/scripts-runbook.md`.
