...
script_tag = '  <script src="/static/js/modules/profile_field_order.js?v=20260508-profile-field-order-v4" defer></script>'

# Remove qualquer referência antiga do script.
text = re.sub(
...
# Garante inclusão apenas no head_extra.
