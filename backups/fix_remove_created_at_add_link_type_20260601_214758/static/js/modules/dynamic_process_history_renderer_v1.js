...
(function registerDynamicProcessHistoryRendererV1() {
  ...
  function renderDynamicProcessHistory(options = {}) {
    ...
    if (showStateColumn) {
      ...
      createHeadRow(dynamicProcessHistoryActiveHeadEl, true, !departmentHistoryMode);
      createHeadRow(dynamicProcessHistoryInactiveHeadEl, true, !departmentHistoryMode);
      renderRows(activeRows, dynamicProcessHistoryActiveBodyEl, true, false, !departmentHistoryMode);
      renderRows(inactiveRows, dynamicProcessHistoryInactiveBodyEl, true, true, !departmentHistoryMode);
