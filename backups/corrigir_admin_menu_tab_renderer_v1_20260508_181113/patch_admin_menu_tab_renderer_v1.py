...
script_tag = '  <script src="/static/js/modules/admin_menu_tab_renderer_v1.js?v=20260508-admin-menu-tab-renderer-v1" defer></script>'
...
print("OK: template atualizado com admin_menu_tab_renderer_v1.js.")
