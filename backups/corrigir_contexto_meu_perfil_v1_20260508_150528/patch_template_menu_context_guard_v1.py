...
script_tag = '  <script src="/static/js/modules/menu_context_guard_v1.js?v=20260508-contexto-meu-perfil-v1" defer></script>'

text = re.sub(
    r'\s*<script\s+src="/static/js/modules/menu_context_guard_v1\.js\?v=[^"]*"\s+defer></script>\s*',
    '\n',
    text,
)
...
print("OK: template atualizado com menu_context_guard_v1.js.")
