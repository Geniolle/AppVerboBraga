...
from appverbo.admin_subprocesses.models import AdminFieldConfig, AdminSubprocessConfig
from appverbo.core import ENTITY_PROFILE_SCOPE_LEGADO, ENTITY_PROFILE_SCOPE_OWNER
