...
def build_user_admin_list_context_v1(
    *,
    ...
    return {
        ...
        "blocked_users": list_result.get("blocked_users", []),
        "non_active_users": list_result.get("non_active_users", []),
...
def build_user_admin_page_payload_v1(
    ...
    return {
        ...
        "blocked_users": list(context.get("blocked_users", [])),
        "non_active_users": list(context.get("non_active_users", [])),
